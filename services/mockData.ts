...
export const initialClasses: ClassGroup[] = [
  {
    ...
    schedule: [
        ...
        { id: 'sch-1', date: '2025-03-01', startTime: '08:00', endTime: '12:00', duration: 4, subjectId: 'sub-1', moduleId: 'Módulo I', instructorIds: ['instr-1'], isCompleted: false },
        { id: 'sch-2', date: '2025-03-02', startTime: '08:00', endTime: '17:00', duration: 8, subjectId: 'sub-2', moduleId: 'Módulo II', instructorIds: ['instr-1'], isCompleted: false },
    ] 
  }
];
